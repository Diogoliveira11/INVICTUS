...
const SettingLink = ({ label, value, onPress }: { label: string, value?: string, onPress?: () => void }) => (
  <TouchableOpacity 
    onPress={onPress}
...
const SettingSwitch = ({ label, description, value, onValueChange }: { 
  label: string, 
  description?: string, 
  value: boolean, 
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#000" }}>
      ...
      <View 
        ...
        className="flex-row items-center px-5 pb-4 border-b border-zinc-900 bg-zinc-900/20"
      >
